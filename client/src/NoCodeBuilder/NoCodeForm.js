...
import FormatOfCSV from "./assets/format.csv";
import validateCSV from "./js/validateCSV";
import GenerateContent from "./GenerateContent";

export default function NoCodeForm({ onSubmit }) {
    ...
    switch (step) {
      ...
      case 7:
        return (
          <div className="space-y-4">
            <label className="block text-lg font-semibold text-gray-700">
              What products are you selling? Upload CSV we can extract it.
            </label>
      ...
      case 9:
        return (
          <div className="space-y-4">
            ...
            {isUploading && (
              <p className="mt-2 text-blue-500">Uploading...Please wait</p>
            )}
          </div>
        );
      case 10:
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      {showGenerateContent ? (
        <GenerateContent formData={formData} />
      ) : (
