    ...
    <main className="bg-green-50 " id="pricing">
      <div className="max-w-6xl mx-auto pt-10 pb-36 px-8">
        <div className="max-w-md mx-auto mb-14 text-center mt-5">
          <h1 className="text-4xl font-semibold mb-6 lg:text-5xl" id="Translatable">
            <span className="text-green-400" >Flexible</span> Plans
          </h1>
          <p id="Translatable" className="text-xl text-gray-500 font-medium">
          Navigate Cross-Border Regulations and Govt. Incentives for Sellers in E-commerce while creating a strong online presence.
